...
Identifies and values the multiple intelligences (MI) of every individual (the 8 intelligences, each with 3 carats, making 24 carats total).

Provides tools (like Unreal Engine and Blender) for education and simulation, and eventually our own reality engine for full EM spectrum simulations.

Creates a society where people are valued for their unique strengths and are helped to develop them (polishing their carats).
